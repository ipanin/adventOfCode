...
# 1. Найти максимальную площадь прямоугольника, у которого диагональные углы находятся
# в отмеченных клетках.
#
# 2. Клетки являются углами ортогонального многоугольника.
# Найти максимальную площадь вложенного прямоугольника,
# диагональные углы которого совпадают с углами многоугольника.
