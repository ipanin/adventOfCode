# Дана карта распространения лучей с препятсвиями, на которых луч раздваивается.
# 1. Посчитать количество раздвоений луча.
# 2. Посчитать все пути в двоичном дереве от корня.
